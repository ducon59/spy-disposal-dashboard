...
card(c2, "②", "Flat Tax — 1 Year",
     ...
     f"Other gains still 26%: €{other_cgt_eur:,.0f}. Total: €{s2_total_eur:,.0f}. "
...
card(c4, "④", f"Relocate ({int(reloc_rate*100)}% CGT)",
     ...
     f"Other gains 26%: €{other_cgt_eur:,.0f}. Total: €{s4_total_eur:,.0f}. "
...
- Other gains at 26% CGT ✗ — remain payable: **€{other_cgt_eur:,.0f}**

**Total cost:** €300,000 + €{other_cgt_eur:,.0f} = **€{s2_total_eur:,.0f}** · **Saved: €{s2_saved_eur:,.0f}**
...
- **{extra_years_line}**
- **Total flat tax:** €{s3_lump_eur:,.0f} · **Other gains (26%):** €{other_cgt_eur:,.0f}
...
The €{other_cap_gains_eur:,.0f} of other (standard CGT) gains remain payable at 26%.
    """)
...
| Other gains 26% CGT | €{other_cgt_eur:,.0f} |
